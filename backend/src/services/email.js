...
function renderTemplate({ title, message, ctaLabel, ctaUrl }) {
  ...
  <div style="max-width:560px;margin:24px auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0">
    <div style="background:#1e3a8a;padding:20px 24px">
      <span style="color:#fff;font-size:18px;font-weight:700">TechOpsHub</span>
    ...
    <div style="padding:24px">
      ...
      ${ctaUrl ? `<a href="${ctaUrl}" style="display:inline-block;background:#2563eb;color:#fff;text-decoration:none;padding:10px 18px;border-radius:8px;font-size:14px;font-weight:600">${ctaLabel || 'Abrir en TechOpsHub'}</a>` : ''}
    </div>
